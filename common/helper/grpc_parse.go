...
type FbJSONPb jsonpb.Marshaler

// ContentType always returns "application/json".
func (*FbJSONPb) ContentType(interface{}) string {
	return "application/json"
}

func (j *FbJSONPb) marshalTo(w io.Writer, v interface{}) error {
...
func (j *FbJSONPb) marshalNonProtoField(v interface{}) ([]byte, error) {
	if v == nil {
...
func (j *FbJSONPb) Unmarshal(data []byte, v interface{}) error {
...
func (j *FbJSONPb) NewEncoder(w io.Writer) runtime.Encoder {
...
func (j *FbJSONPb) Delimiter() []byte {
	return []byte("\n")
}
...
func (j *FbJSONPb) NewDecoder(r io.Reader) runtime.Decoder {
	...
	//todo: 优化
	buf, err := json.Marshal(comReq)
	if err == nil {
		curIo := bytes.NewReader(buf)
		d := json.NewDecoder(curIo)
...
func (j *FbJSONPb) Marshal(v interface{}) ([]byte, error) {
	...
	if data, ok := v.(*pb.ByteResult); ok {
		...
		if len(data.Data) > 0 {
			finalStr.WriteString(",\"data\":")
			finalStr.Write(data.Data)
		}

		finalStr.WriteString("}")
		defer finalStr.Reset()
		return finalStr.Bytes(), nil
	}
